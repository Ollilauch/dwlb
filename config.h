...
// change fg to purple
static pixman_color_t active_fg_color = HEX_COLOR(0xdaa7ffff);
static pixman_color_t active_bg_color = HEX_COLOR(0x222222ff);
static pixman_color_t occupied_fg_color = HEX_COLOR(0x5441A2ff);
...
static pixman_color_t active_bg_color = HEX_COLOR(0x6E56AFff);
static pixman_color_t occupied_fg_color = HEX_COLOR(0xeeeeeeff);
static pixman_color_t occupied_bg_color = HEX_COLOR(0x6E56AFff);
static pixman_color_t inactive_fg_color = HEX_COLOR(0xbbbbbbff);
static pixman_color_t inactive_bg_color = HEX_COLOR(0x222222ff);
static pixman_color_t urgent_fg_color = HEX_COLOR(0x222222ff);
static pixman_color_t urgent_bg_color = HEX_COLOR(0xeeeeeeff);
static pixman_color_t middle_bg_color = HEX_COLOR(0x222222ff);
static pixman_color_t middle_bg_color_selected = HEX_COLOR(0x6E56AFff);
*/
